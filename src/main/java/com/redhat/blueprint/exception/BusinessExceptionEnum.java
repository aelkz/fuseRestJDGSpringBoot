...
public enum BusinessExceptionEnum {
    ...
    CPF(1L, "INVALID_CPF", "CPF inválido."),
    MAP_SIZE(2L, "INVALID_MAP_SIZE", "Tamanho do mapa inválido. É esperado apenas 1 registro a ser inserido no cache por operação.");
